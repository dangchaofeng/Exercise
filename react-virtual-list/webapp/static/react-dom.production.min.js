...
(function (I, ea) {
        ...
        function q(e, g, h, m) {
            ...
            if (null === l) {
                for (; r < h.length; r++)
                    (l = ba(e, h[r], m)),
                        null !== l &&
                            ((g = f(l, g, r)), null === k ? (n = l) : (k.sibling = l), (k = l));
                return n;
            }
        ...
        function w(e, g, h, n) {
            ...
            if (null === r) {
                for (; !v.done; C++, v = h.next())
                    (v = ba(e, v.value, n)),
                        null !== v &&
                            ((g = f(v, g, C)), null === l ? (m = v) : (l.sibling = v), (l = v));
                return m;
            }
    ...
    function lj(a, b) {
        switch (a.tag) {
            ...
            case 13:
                return (
                    q(D), (b = a.effectTag), b & 4096 ? ((a.effectTag = (b & -4097) | 64), a) : null
                );
            case 19:
                return q(D), null;
            case 4:
    ...
    function xj(a, b, c) {
        ...
        U === a && P === c
            ? F === bd || (F === ad && 1073741823 === ta && Y() - Re < Ph)
                ...
                : (jd = !0)
            : Kh(a, c) &&
              ((b = a.lastPingedTime), (0 !== b && b < c) || ((a.lastPingedTime = c), V(a)));
    }
    function qj(a, b) {
        var c = a.stateNode;
        null !== c && c.delete(b);
